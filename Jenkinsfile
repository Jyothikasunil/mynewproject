            ...
            post {
                success {
                    ...
                    emailext to: "jyothikasunil006@gmail.com",
                        ...
                        body: "The integration tests on the staging environment were successful.",
                        attachLog: true
                }
                failure {
                    archiveArtifacts artifacts: 'logs/*', allowEmptyArchive: true
                    emailext to: "jyothikasunil006@gmail.com",
                        ...
                        body: "The integration tests on the staging environment failed.",
                        attachLog: true
                }
            }
        }
            ...
            post {
                success {
                    ...
                    emailext to: "jyothikasunil006@gmail.com",
                        ...
                        body: "The deployment to the production server was successful.",
                        attachLog: true
                }
                failure {
                    archiveArtifacts artifacts: 'logs/*', allowEmptyArchive: true
                    emailext to: "jyothikasunil006@gmail.com",
                        ...
                        body: "The deployment to the production server failed.",
                        attachLog: true
                }
            }
        }
